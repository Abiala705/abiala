...
import profile from "../assets/abiala-profile.jpeg";
        ...
        {isAboveMediumScreens ? (
          ...
          >
            <img
              alt="profile"
              src={profile}
              className="rounded-t-[400px] hover:filter hover:saturate-200 transition duration-500
          ...
          <img
            alt="profile"
            src={profile}
            className="rounded-t-[50%] hover:filter hover:saturate-200 transition duration-500
          z-10 w-full max-w-[400px] md:max-w-[600px]"
          />
        )}
      </div>
